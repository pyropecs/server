...
async function createValues(req, res) {
  ...
  try {
    const result = await pool.query(
      `INSERT INTO weather(temperature,time,altitude,dew_point,pressure,rain,humidity,precipetation) VALUES($1,to_timestamp($2/1000.0),$3,$4,$5,$6,$7,$8)`,
      values
    );
    console.log(result);
  } catch (err) {
